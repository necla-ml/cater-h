...
OUTPUT_DATA_DIR = 'output/example_5_videos'  # Change path to where the videos are stored
LIST_DIR = 'lists'
USE_TRAIN_TEST_SPLIT_FROM = None
MAX_TOT_VIDEOS = 5  # Change number to the actual number of videos generated
np.random.seed(42)
NUM_ROWS = 3
NUM_COLS = 3
ACTION_CLASSES = [
